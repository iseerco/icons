...
export const FiTrPersonWalkingFromLineArrowRight: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
...
FiTrPersonWalkingFromLineArrowRight.displayName = 'FiTrPersonWalkingFromLineArrowRight';
