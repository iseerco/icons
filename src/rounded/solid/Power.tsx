...
export const Power: React.FC<IconProps> = ({ 
  ...
  <svg className={className} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.301 512.301" style="enable-background:new 0 0 512.301 512.301;" xml:space="preserve" width={size} height={size} {...props}>
<g>
