...
export const FiBrGripDotsVertical: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
  ...
  <path d="m11,4.5c0-2.481-2.019-4.5-4.5-4.5S2,2.019,2,4.5c0,1.565.805,2.944,2.022,3.75-1.216.806-2.022,2.185-2.022,3.75s.805,2.944,2.022,3.75c-1.216.806-2.022,2.185-2.022,3.75,0,2.481,2.019,4.5,4.5,4.5s4.5-2.019,4.5-4.5c0-1.565-.805-2.944-2.022-3.75,1.216-.806,2.022-2.185,2.022-3.75s-.805-2.944-2.022-3.75c1.216-.806,2.022-2.185,2.022-3.75Zm-4.5-1.5c.827,0,1.5.673,1.5,1.5s-.673,1.5-1.5,1.5-1.5-.673-1.5-1.5.673-1.5,1.5-1.5Zm0,7.5c.827,0,1.5.673,1.5,1.5s-.673,1.5-1.5,1.5-1.5-.673-1.5-1.5.673-1.5,1.5-1.5Zm0,10.5c-.827,0-1.5-.673-1.5-1.5s.673-1.5,1.5-1.5,1.5.673,1.5,1.5-.673,1.5-1.5,1.5Z"/>
</svg>
);

FiBrGripDotsVertical.displayName = 'FiBrGripDotsVertical';
