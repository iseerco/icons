...
export const FiBrPersonWalkingFromLineArrowRight: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
...
FiBrPersonWalkingFromLineArrowRight.displayName = 'FiBrPersonWalkingFromLineArrowRight';
