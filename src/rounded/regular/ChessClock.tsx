...
export const ChessClock: React.FC<IconProps> = ({ 
  ...
  <svg className={className} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size} {...props}><path d="M19,5h1a1,1,0,0,0,0-2H16a1,1,0,0,0,0,2H7V3H8A1,1,0,0,0,8,1H4A1,1,0,0,0,4,3H5V5a5.006,5.006,0,0,0-5,5v7a5,5,0,0,0,3,4.576V23a1,1,0,0,0,2,0V22H19v1a1,1,0,0,0,2,0V21.576A5,5,0,0,0,24,17V10A5.006,5.006,0,0,0,19,5Zm3,12a3,3,0,0,1-3,3H5a3,3,0,0,1-3-3V10A3,3,0,0,1,5,7H19a3,3,0,0,1,3,3ZM7.5,9A4.5,4.5,0,1,0,12,13.5,4.5,4.5,0,0,0,7.5,9Zm0,7a2.5,2.5,0,1,1,2.288-3.5H8a1,1,0,1,0,0,2H9.788A2.5,2.5,0,0,1,7.5,16Zm9-7a4.5,4.5,0,1,0,3.169,7.69l.013-.008.008-.013A4.5,4.5,0,0,0,16.5,9ZM14,13.5a2.5,2.5,0,1,1,4.823.909l-1.262-1.263a1,1,0,0,0-1.415,1.414l1.263,1.263A2.473,2.473,0,0,1,16.5,16,2.5,2.5,0,0,1,14,13.5Z"/></svg>
);
