...
export const GripHorizontal: React.FC<IconProps> = ({ 
  ...
  <svg className={className} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size} {...props}><path d="m5,4h-2c-1.654,0-3,1.346-3,3v2c0,.552.448,1,1,1h4c.552,0,1-.448,1-1v-4c0-.552-.448-1-1-1Zm-1,4h-2v-1c0-.551.449-1,1-1h1v2Zm10-4h-4c-.552,0-1,.448-1,1v4c0,.552.448,1,1,1h4c.552,0,1-.448,1-1v-4c0-.552-.448-1-1-1Zm-1,4h-2v-2h2v2Zm8-4h-2c-.552,0-1,.448-1,1v4c0,.552.448,1,1,1h4c.552,0,1-.448,1-1v-2c0-1.654-1.346-3-3-3Zm1,4h-2v-2h1c.551,0,1,.449,1,1v1ZM5,14H1c-.552,0-1,.448-1,1v2c0,1.654,1.346,3,3,3h2c.552,0,1-.448,1-1v-4c0-.552-.448-1-1-1Zm-1,4h-1c-.551,0-1-.449-1-1v-1h2v2Zm10-4h-4c-.552,0-1,.448-1,1v4c0,.552.448,1,1,1h4c.552,0,1-.448,1-1v-4c0-.552-.448-1-1-1Zm-1,4h-2v-2h2v2Zm10-4h-4c-.552,0-1,.448-1,1v4c0,.552.448,1,1,1h2c1.654,0,3-1.346,3-3v-2c0-.552-.448-1-1-1Zm-1,3c0,.551-.449,1-1,1h-1v-2h2v1Z"/></svg>
);
