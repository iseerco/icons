...
export const DiscussionIdea: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
  ...
  <rect x="11" width={size} height={size}/>
  <rect x="15.242" y="1.757" width={size} height={size} transform="translate(2.808 12.293) rotate(-45)"/>
  <rect x="6.758" y="1.757" width={size} height={size} transform="translate(.322 6.293) rotate(-45)"/>
</svg>
);

DiscussionIdea.displayName = 'DiscussionIdea';
