...
export const FiTsLeaderboardTrophy: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
  ...
  <rect x="7" y="16" width={size} height={size}/>
  <rect x="5" y="19" width={size} height={size}/>
</svg>
);

FiTsLeaderboardTrophy.displayName = 'FiTsLeaderboardTrophy';
