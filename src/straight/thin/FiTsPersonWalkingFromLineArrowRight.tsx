...
export const FiTsPersonWalkingFromLineArrowRight: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
...
FiTsPersonWalkingFromLineArrowRight.displayName = 'FiTsPersonWalkingFromLineArrowRight';
