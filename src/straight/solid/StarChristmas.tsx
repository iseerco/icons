...
export const StarChristmas: React.FC<IconProps> = ({ 
  ...
  <svg className={className} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size} {...props}><path d="m12,24.038l-3.511-8.527L-.039,12l8.528-3.511L12-.038l3.511,8.527,8.528,3.511-8.528,3.511-3.511,8.527ZM6.957,6.957l.544-1.322L2,2l3.634,5.501,1.323-.545Zm10.086,0l1.279.527,3.678-5.483-5.483,3.678.526,1.279Zm0,10.087l-.526,1.279,5.483,3.678-3.678-5.483-1.279.527Zm-10.086,0l-1.279-.527-3.678,5.483,5.483-3.678-.526-1.279Z"/></svg>
);
