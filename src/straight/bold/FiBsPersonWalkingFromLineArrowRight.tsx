...
export const FiBsPersonWalkingFromLineArrowRight: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor',
  className = '',
  ...props 
...
FiBsPersonWalkingFromLineArrowRight.displayName = 'FiBsPersonWalkingFromLineArrowRight';
